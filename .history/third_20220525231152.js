...
const basketThree = () => {
  ...
  listThree.innerHTML = `<br>1 imported bottle of perfume: ${importedPerfume2PlusTax}
  <br>1 bottle of perfume: ${bottlePerfumePlusTax}<br>1 packet of headache pills: ${pillsPlusTax}
  <br>1 imported box of chocolate: ${importedChocolate2PlusTax}
