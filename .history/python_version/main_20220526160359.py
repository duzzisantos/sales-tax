...
def basketThree():
    ...
    importedBoxOfChocolates2PlusTax = ((importDuty * importedBoxOfChocolates2) / 100) + importedBoxOfChocolates2
    ...
    salesTaxes3 = (
        ...
        (packetOfHeadachePillsPlusTax - packetOfHeadachePills) + (importedBoxOfChocolates2PlusTax - importedBoxOfChocolates2))
