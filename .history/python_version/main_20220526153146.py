...
def basketTwo():
    ...
    importedBoxOfChocolatesPlusTax = ((importDuty * importedBoxOfChocolates) +
                                      importedBoxOfChocolates)
    input("1 imported bottle of perfume at 47.50: ")
    importedBottleOfPerfumePlusTax = (
        (basicPlusImport * importedBottleOfPerfume) + importedBottleOfPerfume)
    ...
    paymentRounded = format((math.ceil(totalPayment2 * 20) / 20), ".2f")

    ## Print receipt

    print("\n BASKET TWO RECEIPT")
    print("1 imported box of chocolates: ", importedBoxOfChocolatesPlusTax)
    print("1 imported bottle of perfume: ", importedBottleOfPerfumePlusTax)