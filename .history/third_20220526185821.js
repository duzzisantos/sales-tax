...
const basketThree = () => {
  ...
  listThree.innerHTML = `<br>1 imported bottle of perfume: ${importedPerfume2PlusTax.toFixed(
    2
  )}
  <br>1 bottle of perfume: ${bottlePerfumePlusTax.toFixed(
    2
  )}<br>1 packet of headache pills: ${pillsPlusTax.toFixed(2)}
  <br>1 imported box of chocolate: ${roundedImportedChoc}
  <br>Sales Tax: ${roundedTaxes}<br><b>Total: ${bottlePerfumePlusTax.toFixed(2) + importedPerfume2PlusTax.toFixed(2) + pillsPlusTax.toFixed(2) + roundedImportedChoc}</b><br>`;
};
