...
let totalPayment = () => {
  return parseFloat(bookPlusTax + musicCDPlusTax + chocPlusTax).toFixed(2);
};
...
let importedPerfPlusTax = (basicPlusImport * importedPerf) + importedPerf
let importedPerfPlusTaxRounded = parseFloat((Math.ceil(importedPerfPlusTax * 20) / 20).toFixed(2))
