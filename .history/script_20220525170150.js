...
const basketTwo = () => {
    ...
    let importedPerfumePlusTax = ((basicPlusImportDuty * +importedPerfume)/100 + +importedPerfume)
...
const basketThree = () => {
    ...
    let importedPerfumePlusTax = ((basicPlusImportDuty * +importedPerfume)/100 + +importedPerfume)
    let bottlePerfumePlusTax = ((basicPlusImportDuty * +bottlePerfume) / 100 + +bottlePerfume)
    let pillsPlusTax = taxFree * pills
}