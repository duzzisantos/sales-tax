...
const basketOne = () => {
  ...
  let bookPlusTax = +taxFree * +book;
  let musicCDPlusTax = ((basicTax * +musicCD) / 100 + +musicCD);
  let chocolateBarPlusTax = +taxFree * +chocolateBar;
  let totalTaxes = +bookPlusTax + +musicCDPlusTax + +chocolateBarPlusTax;
  ...
  listOne[0].append(+bookPlusTax)
  listOne[1].append(+musicCDPlusTax)
  listOne[2].append(+chocolateBarPlusTax)
};
