...
const basketOne = () => {
  for(let i = 0; i< products.length; i++){
    if (
        products[i].productName === "book" &&
        products[i].isNonTaxable === true &&
        products[i].isImported === false &&
        products[i].productName === "musicCD" &&
        products[i].isBasicTaxable === true &&
        products[i].isImported === false &&
        products[i].productName === "chocolateBar" &&
        products[i].isBasicTaxable === true &&
        products[i].isImported === false
      ) {
