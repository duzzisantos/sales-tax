...
test("total price + tax equals 10.50", () => {
    expect(importedChocPlusTax(importedChoc,importDuty)).toBe(10)
})

test("total price + basic + import tax equals 54.65", () => {
    expect(importedPerfPlusTax(importedPerf, basicPlusImport))
})