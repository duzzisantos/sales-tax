...
const basketOne = () => {
  ...
  listOne.innerHTML = `<br>1 book: ${bookPlusTax}<br>1 music CD: ${musicCDPlusTax}<br>1 
  chocolate bar: ${chocolateBarPlusTax}<br>Sales Tax: ${totalTaxes}<br><b>Total: ${netPayment.toFixed(2)}</b><br>`;
};
