...
// let salesTaxes = document.getElementById(".sales-taxes").value;
...
const basketOne = () => {
  ...
  document.getElementById("sales-taxes").value = totalTaxes
  console.log(salesValue)
  let netPayment = salesValue - salesTaxes;
  document.getElementById("total").value = netPayment;
};
